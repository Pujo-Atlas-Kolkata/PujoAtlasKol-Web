...
export default function AboutUsPage() {
  ...
  return (
    <main className="mt-36 flex flex-col w-full max-w-screen-xl mx-auto  backdrop-blur-xs">
      <div className="w-full rounded-2xl border-gray-500">
        <div className="ml-5 flex flex-col gap-y-2 lg:ml-0">
          ...
          <p className="w-full max-w-screen-xl mx-auto  text-lg leading-tight font-normal lg:w-[60dvw]">

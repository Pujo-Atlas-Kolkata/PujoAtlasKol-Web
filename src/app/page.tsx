...
export default function HomePage() {
  return (
    <main className="flex flex-col items-center justify-center pt-32 backdrop-blur-xs lg:pt-52">
      <div className="w-full rounded-2xl border-gray-500 lg:w-fit">
        <div className="flex flex-col gap-y-4 text-center">
          ...
          <p className="px-2 pt-6 pb-3 text-lg leading-none font-normal lg:pt-10 lg:pb-5 lg:text-2xl">
            The most <span className="font-bold">advanced</span> pandal hopping experience in the
            world
          ...
          <div className="flex flex-col items-center justify-center gap-x-0 gap-y-8 lg:flex-row lg:gap-x-20">
            <div className="mt-4 flex flex-col items-center justify-center">
              <NumberTicker
                ...
                startValue={Math.ceil(
                  (new Date(Constants.launchCountdown.daysTillOpenBeta).getTime() -
                    new Date().getTime()) /
                    (1000 * 60 * 60 * 24),
                )}
            ...
            <div className="mt-4 flex flex-col items-center justify-center">
              <NumberTicker
                ...
                value={365}
                startValue={Math.ceil(
                  (new Date(Constants.launchCountdown.daysTillWeLaunchV2).getTime() -
                    new Date().getTime()) /
                    (1000 * 60 * 60 * 24),
                )}
                className="text-7xl font-bold tracking-normal whitespace-pre-wrap lg:text-8xl"
            ...
            <div className="mt-4 flex flex-col items-center justify-center">
              <NumberTicker
                ...
                value={365}
                startValue={Math.ceil(
                  (new Date(Constants.launchCountdown.daysTillDurgaPuja2025).getTime() -
                    new Date().getTime()) /
                    (1000 * 60 * 60 * 24),
                )}
                className="text-7xl font-bold tracking-normal whitespace-pre-wrap lg:text-8xl"
              />
              <div className="text-base lg:text-xs">days till Durga Puja 2025</div>
            </div>
          </div>
        ...
        <div className="mt-10 flex w-full flex-col items-center justify-center text-center">
          <p className="text-2xl font-bold lg:text-4xl">Backed by Amazing Sponsors</p>
      ...
      <div className="w-full max-w-screen-xl mx-auto mx-auto mt-4 flex w-full flex-col items-center justify-between gap-1 px-2 lg:mt-6 lg:w-[calc(100%-5rem)] lg:flex-row lg:gap-4 lg:px-0">
        ...
        <EvervaultCard className="mb-4 h-64 w-full rounded-2xl border-2 border-black bg-amber-300/20 backdrop-blur-3xl lg:mb-0 lg:h-48 lg:flex-1 lg:shadow-[3px_3px_0_3px]">
          <div className="flex h-full w-full flex-col items-center justify-center gap-2 px-4 lg:px-8">
            ...
            <span className="text-lg font-normal text-black">Visitors Per Day</span>
          </div>
        </EvervaultCard>
      </div>
    </main>

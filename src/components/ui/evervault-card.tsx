...
export const EvervaultCard = ({
  ...
  return (
    <div
      className={cn(
        "relative flex aspect-square h-full w-full items-center justify-center bg-transparent p-0.5 backdrop-blur-lg hover:cursor-pointer",
        className,
      )}
    >
      <div
...
export function CardPattern({
  ...
  return (
    <div className="pointer-events-none">
      ...
      <motion.div
        className="absolute inset-0 rounded-2xl bg-gradient-to-r from-red-300 to-amber-400 opacity-0 backdrop-blur-xl transition duration-500 group-hover/card:opacity-100"
        style={style}
      />
      <motion.div
